...
public class ManageCustomerPage extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(ManageCustomerPage.class.getName());

    /**
     * Creates new form ManageCustomerPage
     */
    private User currentUser;

    public ManageCustomerPage(User currentUser) {
        this.currentUser = currentUser;
        DataIO.read(); 
        initComponents();
        new ManageCustomer(this, currentUser);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CustomerId", "Username", "Name", "Gender", "Email", "Phone", "Age"
            }
        ));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(customerTable, javax.swing.GroupLayout.DEFAULT_SIZE, 322, Short.MAX_VALUE)
                .addGap(18, 18, 18)
                .addComponent(backBtn)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        DataIO.read();
        Staff testStaff = DataIO.checkStaffName("admin");
        java.awt.EventQueue.invokeLater(() -> new ManageCustomerPage(testStaff).setVisible(true));
    }
